...
class Variable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $key when calling Variable., must be bigger than or equal to 1.');
        }
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 32768)) {
            throw new \InvalidArgumentException('invalid length for $value when calling Variable., must be smaller than or equal to 32768.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling Variable., must be bigger than or equal to 1.');
        }
