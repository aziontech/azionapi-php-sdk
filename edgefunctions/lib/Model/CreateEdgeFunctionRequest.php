...
/**
 * CreateEdgeFunctionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateEdgeFunctionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateEdgeFunctionRequest';
    ...
    public const INITIATOR_TYPE_EDGE_APPLICATION = 'edge_application';
    public const INITIATOR_TYPE_EDGE_FIREWALL = 'edge_firewall';
    ...
    {
        return [
            self::INITIATOR_TYPE_EDGE_APPLICATION,
            self::INITIATOR_TYPE_EDGE_FIREWALL,
        ];
    }
