...
class CreateRulesEngineRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setOrder($order)
    {
        ...
        if (($order > 10000)) {
            throw new \InvalidArgumentException('invalid value for $order when calling CreateRulesEngineRequest., must be smaller than or equal to 10000.');
        }
        if (($order < 1)) {
            throw new \InvalidArgumentException('invalid value for $order when calling CreateRulesEngineRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateRulesEngineRequest., must be smaller than or equal to 1000.');
        }
