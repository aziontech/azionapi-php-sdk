...
/**
 * OriginsResultResponseAddresses Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OriginsResultResponseAddresses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OriginsResultResponse_addresses';
    ...
    */
     ...
     * Sets server_role
     *
     * @param string $server_role server_role
     *
     * @return self
     */
