...
class PatchRulesEngineRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setOrder($order)
    {
        ...
        if (($order > 10000)) {
            throw new \InvalidArgumentException('invalid value for $order when calling PatchRulesEngineRequest., must be smaller than or equal to 10000.');
        }
        if (($order < 1)) {
            throw new \InvalidArgumentException('invalid value for $order when calling PatchRulesEngineRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets behaviors
     *
     * @return \OpenAPI\Client\Model\RulesEngineBehaviorEntry[]|null
     */
     ...
     * Sets behaviors
     *
     * @param \OpenAPI\Client\Model\RulesEngineBehaviorEntry[]|null $behaviors behaviors
     *
     * @return self
     */
