...
class EdgeApplicationsDeviceGroupsApi
{
     ...
     * @param  string|null $accept The id of the Device Groups that you plan to delete. (optional)
     ...
     * @param  int $edge_application_id edge_application_id (required)
     * @param  int $device_group_id device_group_id (required)
     * @param  string|null $accept The id of the Device Groups that you plan to query. (optional)
     ...
     * @param  \OpenAPI\Client\Model\PatchDeviceGroupsRequest|null $patch_device_groups_request patch_device_groups_request (optional)
     ...
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\PatchDeviceGroupsRequest|null $patch_device_groups_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdDeviceGroupsDeviceGroupIdPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $accept accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\UpdateDeviceGroupsRequest|null $update_device_groups_request update_device_groups_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\UpdateDeviceGroupsRequest|null $update_device_groups_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdDeviceGroupsDeviceGroupIdPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $accept accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\CreateDeviceGroupsRequest|null $create_device_groups_request create_device_groups_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\CreateDeviceGroupsRequest|null $create_device_groups_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdDeviceGroupsPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
