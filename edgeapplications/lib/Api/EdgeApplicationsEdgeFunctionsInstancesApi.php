...
class EdgeApplicationsEdgeFunctionsInstancesApi
{
     ...
     * @param  string|null $accept The id of the edge function instance you plan to query. (optional)
     ...
     * @param  string|null $accept accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationUpdateInstanceRequest|null $application_update_instance_request application_update_instance_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationUpdateInstanceRequest|null $application_update_instance_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdFunctionsInstancesFunctionsInstancesIdPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $accept accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationPutInstanceRequest|null $application_put_instance_request application_put_instance_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationPutInstanceRequest|null $application_put_instance_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdFunctionsInstancesFunctionsInstancesIdPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $accept accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationCreateInstanceRequest|null $application_create_instance_request application_create_instance_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationCreateInstanceRequest|null $application_create_instance_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdFunctionsInstancesPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
