...
class EdgeApplicationsRulesEngineApi
{
     ...
     * @param  \OpenAPI\Client\Model\CreateRulesEngineRequest|null $create_rules_engine_request create_rules_engine_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\CreateRulesEngineRequest|null $create_rules_engine_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdRulesEnginePhaseRulesPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $accept accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\PatchRulesEngineRequest|null $patch_rules_engine_request patch_rules_engine_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\PatchRulesEngineRequest|null $patch_rules_engine_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdRulesEnginePhaseRulesRuleIdPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $accept accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\UpdateRulesEngineRequest|null $update_rules_engine_request update_rules_engine_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\UpdateRulesEngineRequest|null $update_rules_engine_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdRulesEnginePhaseRulesRuleIdPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
