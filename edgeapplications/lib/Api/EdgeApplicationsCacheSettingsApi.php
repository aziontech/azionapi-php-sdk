...
class EdgeApplicationsCacheSettingsApi
{
     ...
     * @param  int $cache_settings_id cache_settings_id (required)
     * @param  string|null $accept accept (optional)
     * @param  \OpenAPI\Client\Model\ApplicationCachePatchRequest|null $application_cache_patch_request application_cache_patch_request (optional)
     ...
     * @param  int $cache_settings_id (required)
     * @param  string|null $accept (optional)
     * @param  \OpenAPI\Client\Model\ApplicationCachePatchRequest|null $application_cache_patch_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdCacheSettingsCacheSettingsIdPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $accept accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationCachePutRequest|null $application_cache_put_request application_cache_put_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationCachePutRequest|null $application_cache_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdCacheSettingsCacheSettingsIdPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $accept accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationCacheCreateRequest|null $application_cache_create_request application_cache_create_request (optional)
     ...
     * @param  string|null $accept (optional)
     * @param  string|null $content_type The type of coding used in the Body (application/json). &lt;br&gt;  Example: Content-Type: application/json (optional)
     * @param  \OpenAPI\Client\Model\ApplicationCacheCreateRequest|null $application_cache_create_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['edgeApplicationsEdgeApplicationIdCacheSettingsPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
