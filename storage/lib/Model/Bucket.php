    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Bucket., must be smaller than or equal to 63.');
        }
        if ((mb_strlen($name) < 6)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Bucket., must be bigger than or equal to 6.');
        }
