...
/**
 * ResponseDeleteBucketData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseDeleteBucketData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseDeleteBucket_data';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ResponseDeleteBucketData., must be smaller than or equal to 63.');
        }
        if ((mb_strlen($name) < 6)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ResponseDeleteBucketData., must be bigger than or equal to 6.');
        }
