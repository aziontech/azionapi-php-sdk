...
/**
 * PatchedBucket Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedBucket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedBucket';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['name']) && (mb_strlen($this->container['name']) < 6)) {
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedBucket., must be smaller than or equal to 63.');
        }
        if ((mb_strlen($name) < 6)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedBucket., must be bigger than or equal to 6.');
        }
     ...
     * Gets edge_access
     *
     * @return \OpenAPI\Client\Model\EdgeAccessEnum|null
     */
     ...
     * Sets edge_access
     *
     * @param \OpenAPI\Client\Model\EdgeAccessEnum|null $edge_access edge_access
     *
     * @return self
     */
