...
/**
     ...
     */
    public function storageApiBucketsObjectsCreate($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsCreate'][0])
    {
        list($response) = $this->storageApiBucketsObjectsCreateWithHttpInfo($bucket_name, $object_key, $request_body, $contentType);
        return $response;
    }
     ...
     */
    public function storageApiBucketsObjectsCreateWithHttpInfo($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsCreate'][0])
    {
        $request = $this->storageApiBucketsObjectsCreateRequest($bucket_name, $object_key, $request_body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storageApiBucketsObjectsCreateAsync($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsCreate'][0])
    {
        return $this->storageApiBucketsObjectsCreateAsyncWithHttpInfo($bucket_name, $object_key, $request_body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storageApiBucketsObjectsCreateAsyncWithHttpInfo($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsCreate'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SuccessObjectOperation';
        $request = $this->storageApiBucketsObjectsCreateRequest($bucket_name, $object_key, $request_body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function storageApiBucketsObjectsCreateRequest($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsCreate'][0])
    {
     ...
     * @return \OpenAPI\Client\Model\SuccessObjectOperation
     */
    public function storageApiBucketsObjectsUpdate($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsUpdate'][0])
    {
        list($response) = $this->storageApiBucketsObjectsUpdateWithHttpInfo($bucket_name, $object_key, $request_body, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\SuccessObjectOperation, HTTP status code, HTTP response headers (array of strings)
     */
    public function storageApiBucketsObjectsUpdateWithHttpInfo($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsUpdate'][0])
    {
        $request = $this->storageApiBucketsObjectsUpdateRequest($bucket_name, $object_key, $request_body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storageApiBucketsObjectsUpdateAsync($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsUpdate'][0])
    {
        return $this->storageApiBucketsObjectsUpdateAsyncWithHttpInfo($bucket_name, $object_key, $request_body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storageApiBucketsObjectsUpdateAsyncWithHttpInfo($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsUpdate'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SuccessObjectOperation';
        $request = $this->storageApiBucketsObjectsUpdateRequest($bucket_name, $object_key, $request_body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function storageApiBucketsObjectsUpdateRequest($bucket_name, $object_key, $request_body = null, string $contentType = self::contentTypes['storageApiBucketsObjectsUpdate'][0])
    {
