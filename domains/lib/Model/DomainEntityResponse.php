...
/**
 * DomainEntityResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DomainEntityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomainEntityResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['digital_certificate_id']) && ($this->container['digital_certificate_id'] > -8446744073709551616)) {
            $invalidProperties[] = "invalid value for 'digital_certificate_id', must be smaller than or equal to -8446744073709551616.";
        }

        if (!is_null($this->container['digital_certificate_id']) && ($this->container['digital_certificate_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'digital_certificate_id', must be bigger than or equal to 1.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DomainEntityResponse., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DomainEntityResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[a-zA-Z0-9$%^&*()-+=\\[\\]{};:?><,|\/]+/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling DomainEntityResponse., must conform to the pattern /[a-zA-Z0-9$%^&*()-+=\\[\\]{};:?><,|\/]+/.");
        }
    ...
    public function setEdgeApplicationId($edge_application_id)
    {
        ...
        if (($edge_application_id > -8446744073709551616)) {
            throw new \InvalidArgumentException('invalid value for $edge_application_id when calling DomainEntityResponse., must be smaller than or equal to -8446744073709551616.');
        }
        if (($edge_application_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $edge_application_id when calling DomainEntityResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setDigitalCertificateId($digital_certificate_id)
    {
        ...
        if (($digital_certificate_id > -8446744073709551616)) {
            throw new \InvalidArgumentException('invalid value for $digital_certificate_id when calling DomainEntityResponse., must be smaller than or equal to -8446744073709551616.');
        }
        if (($digital_certificate_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $digital_certificate_id when calling DomainEntityResponse., must be bigger than or equal to 1.');
        }
