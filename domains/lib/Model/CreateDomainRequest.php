    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateDomainRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateDomainRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[a-zA-Z0-9$%^&*()-+=\\[\\]{};:?><,|\/]+/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CreateDomainRequest., must conform to the pattern /[a-zA-Z0-9$%^&*()-+=\\[\\]{};:?><,|\/]+/.");
        }
    ...
    public function setEdgeApplicationId($edge_application_id)
    {
        ...
        if (($edge_application_id > -8446744073709551616)) {
            throw new \InvalidArgumentException('invalid value for $edge_application_id when calling CreateDomainRequest., must be smaller than or equal to -8446744073709551616.');
        }
        if (($edge_application_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $edge_application_id when calling CreateDomainRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDigitalCertificateId($digital_certificate_id)
    {
        ...
        if ((mb_strlen($digital_certificate_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $digital_certificate_id when calling CreateDomainRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($digital_certificate_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $digital_certificate_id when calling CreateDomainRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[a-zA-Z0-9$%^&*()-+=\\[\\]{};:?><,|\/]+/", ObjectSerializer::toString($digital_certificate_id)))) {
            throw new \InvalidArgumentException("invalid value for \$digital_certificate_id when calling CreateDomainRequest., must conform to the pattern /[a-zA-Z0-9$%^&*()-+=\\[\\]{};:?><,|\/]+/.");
        }
