    ...
    */
    ...
    public function setDigitalCertificateId($digital_certificate_id)
    {
        ...
        if ((mb_strlen($digital_certificate_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $digital_certificate_id when calling DomainEntity., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($digital_certificate_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $digital_certificate_id when calling DomainEntity., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[a-zA-Z0-9$%^&*()-+=\\[\\]{};:?><,|\/]+/", ObjectSerializer::toString($digital_certificate_id)))) {
            throw new \InvalidArgumentException("invalid value for \$digital_certificate_id when calling DomainEntity., must conform to the pattern /[a-zA-Z0-9$%^&*()-+=\\[\\]{};:?><,|\/]+/.");
        }
