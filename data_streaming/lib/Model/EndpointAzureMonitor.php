...
/**
 * EndpointAzureMonitor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EndpointAzureMonitor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Endpoint_Azure_Monitor';
    ...
    */
    ...
    public function setWorkspaceId($workspace_id)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{5}-[a-zA-Z0-9]{5}-[a-zA-Z0-9]{6}/", $workspace_id))) {
            throw new \InvalidArgumentException("invalid value for \$workspace_id when calling EndpointAzureMonitor., must conform to the pattern /[a-zA-Z0-9]{5}-[a-zA-Z0-9]{5}-[a-zA-Z0-9]{6}/.");
        }
