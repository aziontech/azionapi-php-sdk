...
/**
 * CreateNewDataStreamingRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewDataStreamingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateNewDataStreaming_request';
    ...
    */
    ...
    public function setDomainsIds($domains_ids)
    {
        ...
        if ((count($domains_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domains_ids when calling CreateNewDataStreamingRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setSamplingPercentage($sampling_percentage)
    {
        ...
        if (!is_null($sampling_percentage) && ($sampling_percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $sampling_percentage when calling CreateNewDataStreamingRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($sampling_percentage) && ($sampling_percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $sampling_percentage when calling CreateNewDataStreamingRequest., must be bigger than or equal to 0.');
        }
