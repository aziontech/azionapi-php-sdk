...
/**
 * PostCustomDataStreamingResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostCustomDataStreamingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostCustomDataStreamingResponse';
    ...
    */
     ...
     * Sets data_source
     *
     * @param string|null $data_source Options:  * `http` - Edge Applications  * `waf` - WAF Events  * `cells_console` - Edge Functions  * `rtm_activity` - Activity History
     *
     * @return self
     */
     ...
     * Sets template_model
     *
     * @param string|null $template_model Note:  * Add all variables and values that will be used to stream according to the data source you choose to use.
     *
     * @return self
     */
