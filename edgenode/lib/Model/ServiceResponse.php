...
class ServiceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('bind_id', $data ?? [], null);
        $this->setIfExists('is_bound', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bind_id'] === null) {
            $invalidProperties[] = "'bind_id' can't be null";
        }
        if ($this->container['is_bound'] === null) {
            $invalidProperties[] = "'is_bound' can't be null";
        }
    ...
    {
        return $this->container['bind_id'];
    }

    /**
     * Sets bind_id
     *
     * @param int $bind_id bind_id
     *
     * @return self
     */
    ...
    {
        if (is_null($bind_id)) {
            throw new \InvalidArgumentException('non-nullable bind_id cannot be null');
        }
        $this->container['bind_id'] = $bind_id;
    ...
    {
        return $this->container['is_bound'];
    }

    /**
     * Sets is_bound
     *
     * @param int $is_bound is_bound
     *
     * @return self
     */
    public function setIsBound($is_bound)
    {
        if (is_null($is_bound)) {
            throw new \InvalidArgumentException('non-nullable is_bound cannot be null');
        }
        $this->container['is_bound'] = $is_bound;
