...
/**
 * EdgeNodeDetailResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdgeNodeDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EdgeNodeDetailResponse';
    ...
    protected static $openAPITypes = [
        'groups' => '\OpenAPI\Client\Model\NodeGroup[]',
        'has_services' => 'bool',
        'hash_id' => 'string',
        'id' => 'int',
        'modules' => '\OpenAPI\Client\Model\EdgeNodeModules',
        'name' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('has_services', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['has_services'] === null) {
            $invalidProperties[] = "'has_services' can't be null";
        }
     ...
     * Gets groups
     *
     * @return \OpenAPI\Client\Model\NodeGroup[]
     */
     ...
     * Sets groups
     *
     * @param \OpenAPI\Client\Model\NodeGroup[] $groups groups
     *
     * @return self
     */
     ...
     * Sets has_services
     *
     * @param bool $has_services has_services
     *
     * @return self
     */
    public function setHasServices($has_services)
    {
        if (is_null($has_services)) {
            throw new \InvalidArgumentException('non-nullable has_services cannot be null');
        }
     ...
     * Gets modules
     *
     * @return \OpenAPI\Client\Model\EdgeNodeModules
     */
     ...
     * Sets modules
     *
     * @param \OpenAPI\Client\Model\EdgeNodeModules $modules modules
     *
     * @return self
     */
